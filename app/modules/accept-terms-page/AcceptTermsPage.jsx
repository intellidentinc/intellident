...
export default function AcceptTermsPage() {
  ...
  async function handleAccept() {
    ...
    try {
      ...
      if (mustChange) {
        ...
        router.push(clinicId ? `/${clinicId}/dashboard` : '/super')
      }
    } catch {
      showToast('Something went wrong. Please try again.', 'error')
    } finally {
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: 'background.default', display: 'flex', flexDirection: 'column', alignItems: 'center', py: 6, px: 2 }}>
      <Box sx={{ width: '100%', maxWidth: 720 }}>
        ...
        <Box sx={{ textAlign: 'center', mb: 4 }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
            Please read and accept before continuing. Effective: January 1, 2026
          </Typography>
        </Box>

        {/* Notice banner */}
        <Box sx={{ mb: 3, p: 2, bgcolor: '#dbeafe', borderRadius: 2, border: '1px solid', borderColor: '#93c5fd' }}>
          <Typography variant="body2" color="primary" fontWeight={500}>
            Your account was created by clinic staff. Before you can access the system, you must review and accept the Terms of Service and Data Privacy Policy below.
          </Typography>
        </Box>

        {/* Terms content */}
        <Paper elevation={2} sx={{ borderRadius: 3, overflow: 'hidden' }}>
          <Box sx={{ px: { xs: 3, sm: 4 }, py: 4, maxHeight: '60vh', overflowY: 'auto' }}>
            ...
            <Section title="3. Legal Basis and Purpose of Processing">
              <Para>
                We process your personal data under the following lawful bases as defined in Section 12 of RA 10173:
              </Para>
              <BulletList items={[
            ...
            <Section title="11. Contact and Data Protection Officer">
              <Para>For privacy concerns, data subject requests, or security incident reports, contact:</Para>
              <BulletList items={[
          ...
          {/* Action footer */}
          <Box sx={{ px: { xs: 3, sm: 4 }, py: 3, bgcolor: '#f8fafc', display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, alignItems: 'center', justifyContent: 'space-between', gap: 2 }}>
            <Typography variant="body2" color="text.secondary">
              By clicking <strong>Accept &amp; Continue</strong>, you confirm that you have read and agree to the Terms of Service and Data Privacy Policy above.
            </Typography>
            <Box sx={{ display: 'flex', gap: 1.5, flexShrink: 0 }}>
              <Button variant="outlined" onClick={handleDecline} disabled={loading}>
                Decline &amp; Sign Out
              </Button>
              <Button variant="contained" onClick={handleAccept} loading={loading}>
                Accept &amp; Continue
              </Button>
            </Box>
          </Box>
