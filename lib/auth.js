...
export async function setSession(userId, email, firstName, lastName, clinicId, rememberMe = false, superAdmin = false) {
  const cookieStore = await cookies();
  const payload = { userId, email, firstName, lastName, clinicId: clinicId || null, rememberMe: !!rememberMe };
