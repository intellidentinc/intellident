...
export async function sendStaffWelcomeEmail({ to, firstName, role, tempPassword }) {
  const displayName = firstName || 'there';
              ...
              <tr>
                <td style="background:#fef3c7;border-radius:10px;padding:14px 18px;">
                  <table cellpadding="0" cellspacing="0" role="presentation"><tr>
                    <td style="font-size:18px;padding-right:10px;">⚠️</td>
                    <td style="font-size:13px;color:#92400e;line-height:1.5;">
                      Please <strong>change your password</strong> after your first sign-in to keep your account secure.
                    </td>
                  </tr></table>
                </td>
              </tr>
